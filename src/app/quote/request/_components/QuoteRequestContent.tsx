...
type QuoteRequestContentProps = {
  /** URL ?step=1|2|3|4. 없거나 유효하지 않으면 null */
  initialStep: 1 | 2 | 3 | 4 | null;
};

export default function QuoteRequestContent({ initialStep }: QuoteRequestContentProps) {
